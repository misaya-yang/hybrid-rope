...
Pro封板后答复已完成；作者授权的修正T-C距离×结构化竞争确认实验已经完成，
方向为正但区间跨零且存在天花板／地板，按预注册判为未解决，不改变正文主张。
完整结果见[实验owner](experiments/tc_distance_competition_20260918/README.md)。
当前没有其他授权GPU队列。OpenReview表单已填好，最终提交留给作者，仓库不宣称已经提交。
