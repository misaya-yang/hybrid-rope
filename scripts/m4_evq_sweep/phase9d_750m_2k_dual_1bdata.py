...
def main():
    print("#" * 70)
    print("  Phase 9D: 750M, L=2048, Geo vs Hybrid(τ=1.5,r=16), 1B tokens")
    print("#" * 70)
    ...
    geo = results["geo_750m_2k_1bdata"]
    hyb = results["hybrid1.5_r16_750m_2k_1bdata"]
    ...
    print(f"\n{'='*70}")
    print("  SUMMARY (750M, 2 runs, 1B data)")
    print(f"{'='*70}")
    ...
    save_json(WORK / "phase9d_750m_2k_dual_1bdata_summary.json", summary)
    print(f"\nSaved: {WORK}/phase9d_750m_2k_dual_1bdata_summary.json")
