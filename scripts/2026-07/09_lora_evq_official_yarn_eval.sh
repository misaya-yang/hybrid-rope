...
ADAPTER="${EVQ_EVQ_LONGALPACA_ADAPTER:?set EVQ_EVQ_LONGALPACA_ADAPTER}"
...
OUTPUT="${EVQ_OFFICIAL_YARN_OUTPUT:-/tmp/evq_lora_s42_official_yarn_${MODE}.json}"
[[ "$(basename "$ADAPTER")" == "evq_longalpaca_tau1414_s42" ]] || {
