...
Usage:
  ~/miniconda3/bin/conda run -n aidemo python scripts/fig3_pe_dominant_scaling.py

Output:
  - paper_exports/fig3_pe_dominant_scaling.pdf/.png
  - docs/paperdraft/figs/fig3_pe_dominant_scaling.pdf/.png
"""
...
def draw_raw_panel(ax):
    summary = summarize_phase11("results/phase11/results_phase11_raw.json", "ppl")
...
def draw_yarn_panel(ax):
    summary = summarize_phase11("results/phase11/results_phase11_yarn.json", "yarn_auto")
...
def main():
    ...
    legacy_pdf = os.path.join(legacy_dir, "fig3_pe_dominant_scaling.pdf")
    legacy_png = os.path.join(legacy_dir, "fig3_pe_dominant_scaling.png")
    ...
    fig.savefig(legacy_pdf, bbox_inches="tight", pad_inches=0.02)
    fig.savefig(legacy_png, bbox_inches="tight", pad_inches=0.02)
