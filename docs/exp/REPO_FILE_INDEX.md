...
| `paper_exports` | `dir` | `paper_assets` | `ok` |
| `README.md` | `file` | `root_file` | `ok` |
| `results` | `dir` | `curated_results` | `ok` |
| `rope` | `dir` | `core_algorithm` | `ok` |
| `scripts` | `dir` | `execution_entrypoints` | `ok` |
...
| File | Role |
|---|---|
| `docs/EXPERIMENT_REGISTRY.md` | `paper-facing root doc` |
| `docs/METHODOLOGY.md` | `paper-facing root doc` |
| `docs/README.md` | `paper-facing root doc` |
| `docs/REPO_STRUCTURE_CN.md` | `paper-facing root doc` |
| `docs/REPRODUCE.md` | `paper-facing root doc` |
| `docs/RESULTS.md` | `paper-facing root doc` |
| `docs/TERMS_AND_PROTOCOLS.md` | `paper-facing root doc` |
