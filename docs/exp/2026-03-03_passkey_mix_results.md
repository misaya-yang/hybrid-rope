...
- 10% results: `REMOTE_RUN_ROOT/evq_passkey_mix_10pct/results_final.json`
- 5% results: `REMOTE_RUN_ROOT/evq_passkey_mix_5pct/results_final.json`
- PE baselines: `REMOTE_RUN_ROOT/evq_passkey_mix_10pct/pe_baselines_comparison.json`
- EVQ + YaRN combination: `REMOTE_RUN_ROOT/evq_passkey_mix_10pct/evq_yarn_combination.json`
- PE baselines passkey details: `REMOTE_RUN_ROOT/evq_passkey_mix_10pct/pe_baselines_passkey_details.json`
- Model checkpoints: `REMOTE_RUN_ROOT/evq_passkey_mix_{5,10}pct/350m_tau{X}_seed{Y}/model.pt`
- PE baselines script: `scripts/core_text_phases/eval_pe_baselines.py`
- EVQ combination script: `REMOTE_RUN_ROOT/eval_evq_yarn.py`
- EVQ+YaRN all-seeds summary is preserved in this report; the earlier raw local mirror was not retained in the curated repo
