...
| `docs/exp/EXPERIMENT_REPORT_128TOK.md` | Phase 0–3 detailed report |
| `docs/exp/phase6_report.md` | Phase 6 detailed report |
| `docs/exp/EXPERIMENT_RESULTS_128TOK.md` | 128-token paper-ready summary |
| `docs/exp/EXPERIMENT_INVENTORY.md` | curated experiment index |
