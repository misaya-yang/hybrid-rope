...
> **代码**: `scripts/core_text_phases/run_evq_sweep.py`
...
曲线摘要已固化在本报告和 `results/legacy/paper_ready/evq_tau_sweep/evq_sweep_paper_table.csv` 中。当前 curated 仓库不再保留早期一次性分析脚本，而以这份报告作为 canonical narrative summary。
