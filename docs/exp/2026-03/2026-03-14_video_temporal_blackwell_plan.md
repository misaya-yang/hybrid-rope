...
- [videorope_official manifest](../../../data/video_temporal/external/videorope_official/manifest.json)
- [baseline summary script](../../../scripts/video_temporal/summarize_videorope_official_results.py)
...
- [run_video_temporal.py](../../../scripts/video_temporal/run_video_temporal.py)
...
- [prepare_moving_mnist_video.py](../../../scripts/data_prep/prepare_moving_mnist_video.py)

Local cache:

- [moving_mnist_medium manifest](../../../data/video_temporal/generated/moving_mnist_medium/manifest.json)
...
- [prepare_videorope_assets.py](../../../scripts/data_prep/prepare_videorope_assets.py)

Local asset root:

- [videorope_official](../../../data/video_temporal/external/videorope_official)
...
- [run_video_temporal_allocation_sweep.py](../../../scripts/video_temporal/run_video_temporal_allocation_sweep.py)
...
- [run_phase23_blackwell.sh](../../../scripts/video_temporal/run_phase23_blackwell.sh)
- [run_phase23_blackwell_10h.sh](../../../scripts/video_temporal/run_phase23_blackwell_10h.sh)
