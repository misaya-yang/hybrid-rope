...
| O48-24 | Resolved for wording | The historical paper-local rebuttal playbook was retired; its overclaims remain prohibited. The pre-review triage template is archived, and current review-cycle decisions start at `rebuttal/rebuttal_0723/README.md`. | `rebuttal/pre_rebuttal/REVIEWER_TRIAGE_PLAYBOOK.md`, `docs/overview/PAPER_DESCRIPTION_AUDIT.md` | Review again before any final rebuttal submission. |
