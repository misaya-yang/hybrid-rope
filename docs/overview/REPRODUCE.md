...
Figure 3 panel (a) has a curated JSON fallback at `data/curated/fig3_extreme_128.json`; panels (b,c) require local `results/core_text/phase11/results_phase11_{raw,yarn}.json` from the Phase 11 sweep.
...
| ✅ EVQ+YaRN @8K PK retrieval | 100% (vs Geo+YaRN ~61%; teacher-forced NLL-gap retrieval) | Table 2 |
| ✅ PE-dominant 128→8K diagnostic | seed-42 EVQ row lower than Geo/DAPE-style rows; learnable-tau row is 3-seed | Table 4 |
