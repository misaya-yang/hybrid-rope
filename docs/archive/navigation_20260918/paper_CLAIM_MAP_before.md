...
The round's pre-edit baseline is [v4](../history/v4.pdf). Main text: 9 pages; total: 35.
...
The first identification figure now leads with frozen same-range comparisons. Training seed scores remain in Section 3.2 and Appendix C.2; Cosh and NCP serve as supporting studies.
