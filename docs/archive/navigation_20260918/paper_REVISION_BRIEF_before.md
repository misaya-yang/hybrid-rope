...
**当前补充：** 同日逐章节优化保持9／35页，以YaRN／MrRoPE-Pro／TailSpline配置和距离响应概念图替换首图；本次不新增历史版本，详见[逐章收尾](research/revision_20260918/CHAPTER_PASS.md)。

后续每日一版的改稿原则与当前反思见[改稿总结（日记）](research/PAPER_REVISION_DIARY.md)。重点是solid证据、理论与实验的联系、以及读者能理解的主线；不得以每日换版为由机械改写或虚报提升。

## 当前版本：2026-09-18证据升级

[本轮修订owner](research/revision_20260918/README.md)记录Kanana官方部署比较、单侧minimum-bending解释与NCP呈现调整。当前工作稿为35页，修改前基线为v4；标题、章节、核心主图及Cosh／NCP的既有科学职责保持。

作者最新取舍已经落实：Cosh保留；NCP正文按原生窗口研究呈现问题、干预与实际收益，目标函数和求解细节留附录。两部分均未整节删除，作为支持性研究服务于z与TailSpline主线。Astra／Sol同提示词PDF对读已完成。

## 最近完成：逐章最终审核与skills固化

已完成[写作技能提炼与逐章修复](research/revision_20260917_final_editorial/README.md)。
本轮修改前稿保存为v3；文字、术语与局部版面优化保持正文9页、全稿34页和全部实验结果。
下方证据升级记录使用的v2为上一轮基线。

## 当前覆盖：2026-09-17证据升级

正文9页、全稿34页，摘要无数字，第一页无图。保留标题、章节结构、432M曲线、逐任务主图和固定支持识别图。
大样本YaRN、四模型Full-13、70B NF4、GLM新书池及NCP固定支持结果进入本轮。
Native enhancement以真实下游任务质量为核心：Natural-QA旗舰，NLL/PPL预测质量，RULER诊断。
NCP既有内容保留并加入原生NLL证据；NTS2整组保留为历史研究边界，不入本轮稿件。Cosh维持简短的构造/学习支持作用。

[本轮修改和双模型对读](research/revision_20260917_evidence_update/README.md)，
[同轮修改前基线v2](history/v2.pdf)。每轮开始先保存当前未修改PDF为下一历史编号；
中间修复不增加编号，完成稿保留main.pdf。

以下旧页数、未来事项及章节位置按其原日期理解。
