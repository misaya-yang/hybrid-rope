...
**历史准备记录，已由当前稿取代。** 当前状态见[论文入口](../../../paper-2027/index.md)，后续候选见[给Pro的问题](../../../paper-2027/research/revision_20260918/PRO_FINAL_WEEK_QUESTIONS.md)。下方9月16–17日待办、页数和主图建议按原日期理解；不定义当前优先级或队列。
