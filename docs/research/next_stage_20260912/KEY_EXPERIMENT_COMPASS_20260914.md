...
新增完成：**clean X4**在32K的T−C为+2.0962pp，95%区间[1.1134,3.0769]pp；
16K为-0.2513pp且区间跨0。见[Llama结果owner §10](TAILSPLINE_LLAMA_CLASSIC_RESULT_20260914.md#10-clean-x4等位移对照完成2026-09-15服务器回查)。
支持该长端等位移比较的残余形状作用，不把16K或其他方法的排序一并关闭。
