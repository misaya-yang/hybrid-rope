...
**2026-09-18 阅读说明：**以下实验状态与准备建议按9月16日理解；其中直接YaRN、GLM、70B和NCP新面板已有完成证据及稿件整合。
本页继续提供审稿案例与适用问题，当前取舍见[整体改稿入口](../../../paper-2027/research/revision_20260918_preparation/index.md)，不从旧待办重复追加实验。
