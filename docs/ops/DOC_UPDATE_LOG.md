...
## 0.2 2026-02-26 早间诊断文档（服务器实测）

- 新增：
  - `docs/exp/QWEN_FAST400_NO_GAIN_DIAGNOSIS_2026-02-26.md`
- 内容：
  - 基于服务器已落盘结果对 `seed42` 做任务级与审计级诊断。
  - 给出“无整体提升”下的优先级问题归因（数据配方、收敛预算、参数迁移误差）。
  - 明确 `seed1337 anchored` 未完跑前的结论边界与文案降级建议。
