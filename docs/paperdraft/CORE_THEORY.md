...
**文件**：`docs/paperdraft/figs/fig1_frequency_dynamics.png` / `docs/paperdraft/figs/fig1_frequency_dynamics.pdf`
...
**文件**：`docs/paperdraft/figs/fig2_evq_yarn_synergy.png` / `docs/paperdraft/figs/fig2_evq_yarn_synergy.pdf`
...
| Figure | 内容 | 文件 | 状态 |
|--------|------|------|------|
| Figure 1（supporting） | 三联图：(a) 频率分配 (b) PPL 训练动态 (c) Passkey 训练动态 | `docs/paperdraft/figs/fig1_frequency_dynamics.pdf` | ✅ 已完成 |
| **Figure 2（主图）** | EVQ × YaRN：8K retrieval bars + retrieval length curves + PPL length curves | `docs/paperdraft/figs/fig2_evq_yarn_synergy.pdf` | ✅ 已完成 |
| **Figure 3（主图）** | PE-dominant regime / scaling law direct validation：128-token extreme extrapolation + Phase 11 raw/YaRN 双确认 | `docs/paperdraft/figs/fig3_pe_dominant_scaling.pdf` | ✅ |
| Figure 4（待做） | 碰撞块占比 vs base + dead zone | 待生成 | ⏳ |

**理论-叙事-图表矩阵**：见 `docs/paperdraft/figs/README.md`。其中已拆分为“理论严谨矩阵”和“叙事-图表矩阵”两层：前者约束 theorem / proposition / empirical law / appendix caution 的身份，后者负责把理论核心、叙事核心与正文图表资产对齐。
...
| Paper figures（Fig 1 / Fig 2） | ✅ 已集中到 `figs/` | `docs/paperdraft/figs/` |
| LaTeX 正文 | ❌ 未开始 | — |
| Appendix 证明 | ❌ 未开始 | — |
