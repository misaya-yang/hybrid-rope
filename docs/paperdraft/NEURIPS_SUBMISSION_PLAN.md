...
> Status: implemented in `paper/neurips_submission/`.
...
- `docs/paperdraft/figs/fig2_evq_yarn_synergy.pdf`
- `docs/paperdraft/figs/fig3_pe_dominant_scaling.pdf`

Supporting figure referenced for appendix planning:

- `docs/paperdraft/figs/fig1_frequency_dynamics.pdf`
