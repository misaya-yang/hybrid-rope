...
| Figure | 文件 | 生成脚本 | 当前定位 |
|--------|------|----------|----------|
| Figure 1 | `fig1_frequency_dynamics.pdf` / `.png` | `scripts/fig1_neurips.py` | supporting mechanism / dynamics |
| Figure 2 | `fig2_evq_yarn_synergy.pdf` / `.png` | `scripts/fig2_evq_yarn_orthogonality.py` | **main empirical figure** |

## Submission implementation

- Canonical anonymous submission plan:
  [NEURIPS_SUBMISSION_PLAN.md](/Users/misaya.yanghejazfs.com.au/neurIPS-2026/hybrid-rope/docs/paperdraft/NEURIPS_SUBMISSION_PLAN.md)
- Implemented review-version skeleton:
  [main.tex](/Users/misaya.yanghejazfs.com.au/neurIPS-2026/hybrid-rope/paper/neurips_submission/main.tex)
...
| 主图 2 | **Figure 3** | [fig3_pe_dominant_scaling.pdf](/Users/misaya.yanghejazfs.com.au/neurIPS-2026/hybrid-rope/docs/paperdraft/figs/fig3_pe_dominant_scaling.pdf)；承载 DAPE-style extreme extrapolation + Phase 11 `τ*` 直观确认 |
