...
| **8C** | **✅** | From-scratch 4K: EVQ PPL@16K 164.4 **赢 Geo 175.4 (-6.3%)**; Passkey EVQ 66% < Geo 69% (-3pp, 可能因 τ=2.0 非最优) |
...
- 8C from-scratch 4K: EVQ PPL **赢 6.3%**, Passkey 输 3pp（τ=2.0 非最优，scaling law 预测 τ*=1.0）
- **Alignment cost 论证**：extension gap 6.75pp → from-scratch gap 3pp，alignment cost 是主因；剩余 gap 归因于 τ 过大

**⚠️ Passkey 是论文生死线**: 详见 `docs/paperdraft/phase8_analysis.md` 第三/四节
