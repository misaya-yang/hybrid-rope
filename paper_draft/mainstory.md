...
> **最后更新**：2026-03-11（v15 PE论文对标调研更新 + 模型规模/下游任务事实修正；全实验组合完善 + Phase 17b bridging + 核心叙事"训练时 stronger + 推理时完美适配"；Phase 17c headline: EVQ+YaRN@48K PPL=2.63，三阶段超线性 34.6%→52.0%→81.2%）
...
**唯一核心近似**：Broadband 投影（步骤 2→3）。残差 O(1/lnb)（δ 脊物理宽度），真实语料距离先验下 R²>0.9（FineWeb-Edu 实测 R²≈0.91，短窗口 L=512 可达 0.96）。其余全是精确推导。
...
| **R² multi-dataset** | — | — | 5 corpora | R²=0.90-0.94，broadband corpus-independent | **A** |
