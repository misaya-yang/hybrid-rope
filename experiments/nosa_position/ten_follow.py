...
def main():
    ...
    def execute(mode,ids,suffix='',seed=None):
        ...
        command=[sys.executable,'-u','-c','import torch; torch.cuda.set_per_process_memory_fraction(0.52); from experiments.nosa_position.ten_run import main; main()',
            ...
            '--chunk-size','1024','--attention-query-chunk-size','1024']
