...
grep -q '^QUEUE_COMPLETE ' "${qwen_root}/logs/supervisor.log"
exec /root/autodl-tmp/hybrid-rope/experiments/fixed_rope_three_interfaces_20260913/run_llama_s4_factorial_gap48.sh
