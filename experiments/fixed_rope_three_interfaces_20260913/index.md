...
| 准备Full-13与PPL50资产 | [prepare_tailspline_llama_classic_assets.sh](prepare_tailspline_llama_classic_assets.sh)：CPU-only |
...
结果以目标运行目录的完整raw、完成回执和配对报告为准。Core-6首判不等于最终PPL、NIAH/passkey与full-13 RULER交付。
