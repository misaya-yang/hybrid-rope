...
**C7 — Grid-convention nuisance.** `tau=0, midpoint=true` is not original RoPE: the half-cell shift alone improved 16K diagnostic NLL from 14.87 to 13.77 in the base-model diagnostic (`docs/exp/2026-07/2026-07-14_lora_retrieval_conversion_probe.md`, "Geo identity"). Any experiment that labels midpoint-τ0 as "geometric baseline" imports a free confound; T2 used the true native tensor for the Geo arm (buffer error 1.8×10⁻⁸), but new experiments must re-check this.
...
| `docs/exp/2026-07/2026-07-14_lora_retrieval_conversion_probe.md`, `docs/exp/2026-07/2026-07-15_lora_readout_conversion_plan.md`, `docs/exp/2026-07/2026-07-15_readout_conversion_impl_plan.md` | Protocol definitions and stop history |
