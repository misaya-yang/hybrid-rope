...
def build_pdf():
    output_path = os.path.join(os.path.dirname(__file__), "briefings", "team_briefing_evq.pdf")
    ...
    files_data = [
        ["File", "Purpose"],
        ["paper_draft/CORE_THEORY.md", "Source of truth: all verified theory + data"],
        ["paper_draft/NEURIPS_SUBMISSION_PLAN.md", "Formal submission constraints and page plan"],
        ["docs/exp/2026-03-03_passkey_mix_results.md", "Complete passkey mix + PE baselines data"],
        ["paper_draft/mainstory.md", "Spotlight-oriented one-page narrative spine"],
        ["paper_draft/submission/main.tex", "Current anonymous submission draft"],
        ["paper_draft/figs/README.md", "Paper figure/table matrix: theory core ↔ narrative core ↔ assets"],
        ["paper_draft/figs/fig1_frequency_dynamics.pdf", "Supporting figure: frequency allocation + 750M dynamics"],
        ["paper_draft/figs/fig2_evq_yarn_synergy.pdf", "Main figure: EVQ × YaRN orthogonality / synergy"],
    ]
