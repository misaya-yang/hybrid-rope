...
`../FREQUENCY_DEFINITION_MANIFEST.json`.
...
python -m rebuttal.rebuttal_0723.reviewer27be_shape_base.prepare \
  --source_manifest "$SOURCE_MANIFEST" \
  --output_dir "$WORK_DIR/data"

bash rebuttal/rebuttal_0723/reviewer27be_shape_base/run_5090.sh preflight
```
...
```bash
bash rebuttal/rebuttal_0723/reviewer27be_shape_base/run_5090.sh shape
bash rebuttal/rebuttal_0723/reviewer27be_shape_base/run_5090.sh heldout
```
