...
```bash
PYTHONPATH=. python \
  rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/prepare.py \
...
```bash
bash rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/run_5090.sh preflight
bash rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/run_5090.sh gate
# Run only when operator_parity_gate.json says PASS:
bash rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/run_5090.sh confirm
```
...
bash rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/run_5090.sh status

# One snapshot every 300 seconds; exits at STOP or final summary:
MONITOR_INTERVAL_SECONDS=300 \
  bash rebuttal/rebuttal_0723/mla_yarn_operator_parity_5090/run_5090.sh monitor
```
