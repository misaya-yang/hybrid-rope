...
```bash
bash rebuttal/rebuttal_0723/mla_scarcity_5090/run_5090.sh preflight
```
...
bash rebuttal/rebuttal_0723/mla_scarcity_5090/run_5090.sh gate

# Only after a PASS gate: seeds 43/88, test evaluation, YaRN diagnostic, summary.
bash rebuttal/rebuttal_0723/mla_scarcity_5090/run_5090.sh confirm
```
...
```bash
bash rebuttal/rebuttal_0723/mla_scarcity_5090/run_5090.sh disk
```
...
```bash
bash rebuttal/rebuttal_0723/mla_scarcity_5090/run_5090.sh cleanup-cache
```
