...
python -m pytest rebuttal/real_dape_compare/tests/test_smoke.py -q
# 或
python rebuttal/real_dape_compare/run_dape_compare.py --dry-run
python rebuttal/real_dape_compare/run_dape_compare.py --smoke --methods geo,evq --work /tmp/dape_smoke
```
...
python rebuttal/real_dape_compare/run_dape_compare.py \
  --protocol p1 \
  --seeds 42 \
