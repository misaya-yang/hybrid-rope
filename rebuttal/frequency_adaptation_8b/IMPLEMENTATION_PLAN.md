...
- Modify: `rebuttal/rebuttal_playbook.md`
...
```bash
rg -n "no-new-experiments|不补充任何新实验|不启动 7B/8B实验|新 LoRA、video" rebuttal/rebuttal_playbook.md rebuttal/README.md
```
...
- Create: `rebuttal/frequency_adaptation_8b/__init__.py`
- Create: `rebuttal/frequency_adaptation_8b/curriculum.py`
...
- Create: `rebuttal/frequency_adaptation_8b/prepare_data.py`
...
```bash
python -m py_compile rebuttal/frequency_adaptation_8b/prepare_data.py
python -m pytest tests/test_frequency_adaptation_8b.py -q
```
...
- Create: `rebuttal/frequency_adaptation_8b/train.py`
...
```bash
python -m py_compile rebuttal/frequency_adaptation_8b/train.py
python -m rebuttal.frequency_adaptation_8b.train --help
```
...
- Create: `rebuttal/frequency_adaptation_8b/evaluate.py`
- Create: `rebuttal/frequency_adaptation_8b/run_seed42.sh`
...
```bash
python -m py_compile rebuttal/frequency_adaptation_8b/evaluate.py
bash -n rebuttal/frequency_adaptation_8b/run_seed42.sh
python -m rebuttal.frequency_adaptation_8b.evaluate --help
```
...
python -m pytest tests/test_frequency_adaptation_8b.py -q
python -m py_compile \
  rebuttal/frequency_adaptation_8b/curriculum.py \
  rebuttal/frequency_adaptation_8b/prepare_data.py \
  rebuttal/frequency_adaptation_8b/train.py \
  rebuttal/frequency_adaptation_8b/evaluate.py
bash -n rebuttal/frequency_adaptation_8b/run_seed42.sh
git diff --check
git status --short
```
