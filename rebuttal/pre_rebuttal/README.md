# Pre-rebuttal retained evidence and code

最后审计：2026-07-26

本目录只保留正式 reviews 到来前仍有直接复用价值的理论底稿、结果说明和实验
实现。模拟审稿、重复 playbook、宽问题账本、未来工作提案与过时执行说明已从
`main_0726` 移除；如需追溯，可从 `main` 或备份分支读取。
