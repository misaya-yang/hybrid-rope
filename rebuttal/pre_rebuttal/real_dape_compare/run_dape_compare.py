...
Usage:
  python rebuttal/pre_rebuttal/real_dape_compare/run_dape_compare.py --smoke
  python rebuttal/pre_rebuttal/real_dape_compare/run_dape_compare.py --dry-run
  python rebuttal/pre_rebuttal/real_dape_compare/run_dape_compare.py --protocol p1 --seeds 42 \\
