...
> **2026-07-26 authority note:** 本文保留为 ordinary-KL、transport proxy 与
> cosh surrogate 的长推导参考。关于 method identity、dimension scaling、
> collision calibration、Phase16 与最终 survivor set，以
