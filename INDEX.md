...
| [Native phase constrained carrier](docs/research/ROPE_NATIVE_SECTOR_CARRIER_20260907.md) | Core experiment 3: same Native quadratic projected into each slow slot's causal phase sector, on fixed MrPro; distinct from original signed trial; no parameter sweep |
