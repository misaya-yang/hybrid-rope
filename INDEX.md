...
| [Sparse-memory interface pilot](docs/research/SPARSE_MEMORY_INTERFACE_PILOT_20260908.md), [implementation](scripts/experiments/sparse_memory/), [checks](tests/test_sparse_memory.py) | Active bounded synthetic A/B study: gate+APE, source binding, paired generated answers; protocol owns predictions/results, HANDOFF owns authorization and live state |
