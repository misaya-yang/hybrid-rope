...
| [Native phase constrained carrier](docs/research/ROPE_NATIVE_SECTOR_CARRIER_20260907.md) | Core experiment 3: fixed MrPro plus constrained tail; development and first six full RULER task results, actual long-phase numerical check; no parameter sweep or SOTA claim |
...
| [Unified frequency research plan](docs/research/ROPE_FREQUENCY_UNIFIED_PLAN_20260907.md) | Current zero-training to LoRA to sparse-attention order; physical 64K data, original-Native replay and fixed adapter implementation; old matrix suggestions superseded |
