...
| [Shared-frequency output response](scripts/analysis/shared_frequency_response.py) | Exact frozen-QKV/GQA output Jacobian retaining cross-key and cross-head cancellation; NumPy algebra checked, real-cache analysis pending; not a loss optimizer or new deployment method |
