...
| [Qwen 1.5B minimal mechanism comparison](docs/research/ROPE_QWEN15_MINIMAL_MECHANISM_20260907.md), [fixed tables](docs/research/ROPE_QWEN15_FULL_LAG_P2_CANDIDATE_20260907.json), [full-lag audit](scripts/analysis/audit_qwen_p2_full_lag.py) | Current small-model protocol: one numerical repair of the old effective rule, official and matched-gain Mr references, actual generation decisions; supersedes full 3B matrix |
