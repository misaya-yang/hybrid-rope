...
We test the finite-budget hypothesis in a 432M-parameter transformer following
...
\begin{center}
  \includegraphics[width=0.96\linewidth]{fig_range_composition_454m.pdf}
  \captionof{figure}{\textbf{The same range operator has substrate-dependent
  leverage in the tested protocol.} Three-seed PK@8K means, individual seeds,
  and standard deviations: \rs{} raises Geo from $41\%$ to $61\%$ and \evq{}
  from $53\%$ to $100\%$.}
  \label{fig:range-composition-454m}
\end{center}

Applying the same \rs{} operator adds $20$ points on Geo and $47$ points on
\evq{}, a $27$-point leverage difference under the shared code path, cut
indices, scale, and evaluation rows.
