...
\]
The outer bands agree, so BM and Uni have identical full-table displacement, whereas BM exceeds Pro by $(n-1)\log s/6$. On the actual $K=64$, $[l,h]=[14,32]$ grid, full-table $\sum_km_k$ is $40.5$ for BM/Uni and $37\frac23$ for Pro. The $16$K BM--Uni difference of $19.20$ points therefore compares different shapes at equal total displacement. The six-task development panel tests shape at fixed total displacement; natural QA and C42 use their own panels.
