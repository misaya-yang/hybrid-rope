...
the $32$ anchors are paired observations within a seed. This is a two-seed
mechanism replication of weight--table co-adaptation, not a replacement for the
three-seed exact-range effect and not evidence that either derived table is
globally optimal.
