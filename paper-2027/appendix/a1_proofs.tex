...
For the original, unwhitened pair on $[0,L]$, put $x=\omega L$.
The self-Gram eigenvalues are
\[
...
continuous optimum into an explicit finite table. This construction is
specified by its allocation criterion; the full-subspace geometry and trained
comparisons evaluate distinct consequences of the resulting table.
