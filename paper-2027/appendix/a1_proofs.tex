...
correlation Gram of the corresponding full sin/cos pairs is $R=I_{2K}$, hence
$r_2(R)=2K$. Nevertheless the complete positional feature map satisfies
...
checks the resulting allocation against the exact oscillatory kernel, and the
