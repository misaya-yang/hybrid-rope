...
is the linear movement ramp with minimum displacement-space MSE to the frozen
derived table over the registered discrete profiles; its choice uses no task
