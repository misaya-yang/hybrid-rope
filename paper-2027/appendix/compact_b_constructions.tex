...
The finite-sum identities are checked with exact rational arithmetic in the
bundled allocation constructor.
...
\subsection{Turn boundaries across native bases}
