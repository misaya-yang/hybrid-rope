...
## 当前覆盖：2026-09-16证据增量版

现稿主文9页、全稿33页，摘要163词且无数字，第一页无图。
标题与章节结构保持；最新完成的直接基线、GLM和长书QA已加入。
主文保留432M曲线、逐任务图及自然QA区间；Cosh以简洁构造和实验连接服务于z主张。
151.9M固定端点属于同一训练证据链，不是FMRoPE方法比较。

[本轮修改与审稿处理](research/revision_20260916_evidence_update/README.md)，
[历史回溯](research/revision_20260916_evidence_update/cosh_history.md)，
[本轮修改前基线v1](history/v1.pdf)。每轮修改前先把当时main.pdf存为历史最大版本加一，
再由Astra/Sol同提示词、仅PDF对读新稿和该快照；history只保存PDF。

以下旧页数、未来事项及章节位置均按其原日期理解。
