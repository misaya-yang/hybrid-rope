...
[本轮升级与回归检查](../revision_20260917_evidence_update/README.md)对应9/34页稿件。
A59/A60/A61已进入直接基线、自然任务和70B规模迁移；A54/A62保留NCP固定支持内容，新增原生NLL及上下文利用结果。
NTS2整组保留为[后续研究](../revision_20260917_evidence_update/NATIVE_FOLLOWUP.md)，等待更完整QA确认，不纳入本轮投稿包。
