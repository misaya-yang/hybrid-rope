...
| --- | --- | --- |
| [Pro materials reviewed for company-PC continuation](pro-materials-20260908/) | Nine newly preserved verbatim RoPE sources; the tenth is the existing scale-transport source. [Coverage/SHA ledger](../../../docs/research/ROPE_SOURCE_COVERAGE_20260908.json) also records two screened other-topic inputs that were not copied | Source input only; ten full-text reviews reconciled with local failures in the [synthesis](../../../docs/research/ROPE_LOCAL_FAILURE_SYNTHESIS_20260908.md). Original trailing whitespace retained for byte identity; no execution authority |
