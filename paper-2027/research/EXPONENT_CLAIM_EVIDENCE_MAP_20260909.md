...
当前部署目标与设计手段见[当前研究入口](../../docs/research/next_stage_20260912/index.md)。成熟部署现为§5，学习期构造为§6；旧日期段落保留原有历史位置。
...
§2 定义可干预对象 → §3 证明作用并刻画位置基 → §4 说明学得使用和安装关系 → §5 在成熟模型中利用同一设计自由度 → §6 构造并展示学习收益 → §8 汇总正面认识和可实践的设计方式。
