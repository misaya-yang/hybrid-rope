...
- **Supersedes:** the decision gates in
  `../../preflights/causal-mechanism/SAME_SUPPORT_CONTROL_PREFLIGHT_20260823.md` and the planned
  status in `../../preflights/causal-mechanism/SMALL_MODEL_RETROFIT_CAUSAL_PREFLIGHT_20260823.md`
