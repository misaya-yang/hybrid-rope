...
snapshot. Manuscript work starts from the current source under
[`REVISION_BRIEF.md`](REVISION_BRIEF.md); active research is routed through
`INDEX.md` §5 and remains separate from manuscript evidence until promoted.
