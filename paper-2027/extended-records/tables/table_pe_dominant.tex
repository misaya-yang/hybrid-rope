\begin{table}[h]
\caption{Learned-frequency comparator (approximately $151.9$M, $\Ltr{=}128$, FineWeb-Edu,
$128\to8$K). Geo denotes the midpoint geometric grid. Geo, learned-inv-freq, and \evq{} are seed $42$; learnable-$\tau$
