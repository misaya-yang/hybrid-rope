...
$u_k=(k+1/2)/K$ for this diagnostic ($K=32$, $b=500{,}000$, $L=512$). Static rank uses equal weights on integer separations $0,\ldots,511$, distinct from the continuous measure of the main geometric proposition. The matched pairs remain near PPL $7$, whereas both
