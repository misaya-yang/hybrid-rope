...
Lead with useful allocation and executable constructions. Fixed-support controls identify z; complete methods may combine allocation with range, band and gain. Geometry explains supplied positional structure without claiming an identified task-loss mediator.

## Main displays

Figure 1: fixed-endpoint allocation, three-seed loss differences and frozen task scores. Figure 2: full-pair geometry and multi-seed MLA curves, with distinct protocol labels. Figure 3: matched TailSpline/MrPro length responses on Llama and OLMo. Table 1: separately labeled learning/adaptation evidence. Table 2: BM natural QA.
