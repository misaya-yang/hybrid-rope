...
\citep{bai2024longbench,hsieh2024ruler}. Information can be lost despite being
present in the prompt \citep{liu2024lost}, and positional interventions can
mitigate this failure \citep{zhang2024found}. We use PE-dominant diagnostics for
mechanism and RULER for effective-context claims, while keeping task-family
adaptation distinct from unseen-task transfer.
