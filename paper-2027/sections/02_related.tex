...
degree it controls; the interventions are nonexclusive and composable.
...
and subspaces \citep{zhang2026grape}; Selective RoPE instead learns
input-dependent rotation angles \citep{movahedi2026selectiverope}. Analyses of
attention logits further distinguish additive and multiplicative positional
biases \citep{gu2026deconstructing}. Our identification keeps the rotary
...
table still requires an optimization run. AdaRoPE instead learns per-head
...
re-positioning \citep{zheng2024dape,li2024fire,hua2025fope,li2025repo}, change a
