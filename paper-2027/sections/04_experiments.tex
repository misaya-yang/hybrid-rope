...
The Cosh construction gives a fixed exponent table that can be used in
training or adaptation. We now examine its effects on language modeling,
retrieval, and source use, following the controlled findings in
\S\ref{sec:controlled-findings}.
