...
retrieval, and source use under the stated complete-table interventions,
following the fixed-endpoint controls in
...
In one matched $750$M continuation pair, both arms train at length $4096$.
...
We compare one Native/\evq{} pair under the same $300$-step rank-$64$ Q/K/V/O LoRA
