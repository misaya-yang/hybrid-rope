...
Finite-window overlap identifies frequency spacing as a structural design choice. Learning can adapt to a newly supplied basis, whereas frozen deployment uses an existing frequency--coordinate association. We therefore design a full table through a density prior during learning, and a native-relative transition through a boundary prior during deployment.
