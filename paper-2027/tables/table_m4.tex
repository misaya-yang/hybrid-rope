...
over $2\times/4\times/8\times$, paired within configuration and seed. CIs are
$10{,}000$ configuration-level bootstraps; $p$ is a two-sided exact sign-flip
over all $2^{12}$ assignments, unadjusted across contrasts
