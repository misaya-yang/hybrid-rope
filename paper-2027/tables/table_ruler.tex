...
OLMo Q/K-only freezes inherited V/O LoRA and trains only the tensors RoPE acts on. The Llama rows use the separate RULER-family continuation: $516$ steps, rank-$64$ Q/K/V/O LoRA, length $8192$, seed $20420726$. The $300$-step LongAlpaca adaptation supplies the temporal-PPL and gold-block results, not these RULER scores.}
\label{tab:ruler}
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{}llccc@{}}
\toprule
