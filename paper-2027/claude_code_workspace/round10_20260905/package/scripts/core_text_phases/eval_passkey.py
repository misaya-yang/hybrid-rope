...
Usage:
    python scripts/core_text_phases/eval_passkey.py --work_dir ~/evq_sweep --tiers 50m,125m,500m
    python scripts/core_text_phases/eval_passkey.py --work_dir ~/evq_sweep --tiers 500m --taus 0.0,1.5
"""
