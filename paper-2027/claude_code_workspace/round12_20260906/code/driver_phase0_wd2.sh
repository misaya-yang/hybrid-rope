#!/bin/bash
# Round 12 Phase 0b re-run #2 (2026-09-06) — §2.3 relative-frame fix.
...
LOG=$B12/diag/driver_phase0_wd2.log
SUM=$B12/diag/driver_phase0_wd2_summary.txt
...
echo "WD_RERUN2_START $(date -u +%FT%TZ)" >> $LOG
: > $SUM
...
echo "WD_RERUN2_END $(date -u +%FT%TZ)" >> $LOG
