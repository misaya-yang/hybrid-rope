...
先解释 FullLagP2 在64K、128K与3B上的收益和代价，再据此改方法；当前优先分析
近邻原生位置计算与远程P2相位范围的分工，见[零训练第一步](docs/research/ROPE_ZERO_TRAINING_MRPRO_STEP1_20260908.md)。
...
| [零训练第一步](docs/research/ROPE_ZERO_TRAINING_MRPRO_STEP1_20260908.md) | 同输入结果重分析、机制假说、近邻/远程位置算子与可推翻预测；撤回先扩13项的建议 |
